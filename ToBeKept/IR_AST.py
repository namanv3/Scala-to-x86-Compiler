...
def p_func_call(p):
	...
	for i in p[2]:
		...
		nextstat += 1
	f.write(str(nextstat) + ": " + "fcall " + str(p[1]['place']) + "\n")
	nextstat += 1
...
def p_if_b_m(p):
	...
	global nextstat
	global else_count
	f.write(str(nextstat) + ": " + "if" + p[-2]['place'] + " = 0 goto " + " ELSE" + str(else_count) +"\n")
	# begin_count += 1
	nextstat += 1
	S.startScope()
...
def p_if_i_m(p):
	...
	global else_count
	S.startScope()
	f.write(str(nextstat) + ": " + 'ELSE' + str(else_count) +":\n")
	# begin_count += 1
	nextstat += 1
...
def p_if_e_m(p):
	...
	global nextstat
	global after_count
	f.write(str(nextstat) + ": " + " goto AFTER" + str(after_count) +"\n")
	nextstat += 1
	# begin_count += 1
	f.write(str(nextstat) + ": " + "AFTER" + str(after_count) +":\n")
	# begin_count += 1
